        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div>
                    ...
                    <input class="form-control" name="first_name" id="first_name" type="text" placeholder="Enter your first name" required value="{{ old('first_name') }}">
                </div>
            </div>
            <div class="col-md-6 mb-3">
                <div>
                    <label for="last_name">Last Name</label>
                    <input class="form-control" name="last_name" id="last_name" type="text" placeholder="Also your last name" required value="{{ old('last_name') }}">
                </div>
            </div>
        </div>
        <div class="row align-items-center">
            <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input data-datepicker="" class="form-control" name="birthday" id="birthday" type="text" placeholder="dd/mm/yyyy" required value="{{ old('birthday') }}">
                </div>
            </div>
            <div class="col-md-6 mb-3">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    ...
                    <input class="form-control" name="email" id="email" type="email" placeholder="name@company.com" required value="{{ old('email') }}">
                </div>
            </div>
            <div class="col-md-6 mb-3">
                <div class="form-group">
                    <label for="phone">Phone</label>
                    <input class="form-control" name="phone" id="phone" type="number" placeholder="+12-345 678 910" required value="{{ old('phone') }}">
                </div>
            </div>
        </div>
        <div class="mt-3">
