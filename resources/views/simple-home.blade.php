...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            {{-- Bagian yang Diperbarui: Menampilkan Username dari Session --}}
            @if (session('username'))
                <h1>Welcome Back, {{ session('username') }}!</h1>
                {{-- Menampilkan flash message 'success' dari proses login --}}
                @if (session('success'))
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Our application provides a clean and intuitive interface,
                             allowing users to
                            navigate easily and perform tasks efficiently. Built with Laravel and
                            Bootstrap, it offers
